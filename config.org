...
* General
  ...
  #+begin_src emacs-lisp
  (use-package frame-local) ;; company-box dependency
...
** Font
   ...
   (set-face-attribute 'mode-line-inactive nil :font "Roboto Mono" :height 120)
   #+end_src
...
** Visual help
   ...
   (use-package highlight-indent-guides
     ...
     (setq highlight-indent-guides-method 'fill
           ...
           highlight-indent-guides-auto-odd-face-perc 6)
     :hook
